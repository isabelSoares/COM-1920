...
void og::frame_size_calculator::do_function_invocation_node(og::function_invocation_node * const node, int lvl) {
  // EMPTY
}
...
void og::frame_size_calculator::do_allocation_node(og::allocation_node *const node, int lvl) {
  // EMPTY
}
...
void og::frame_size_calculator::do_index_tuple_node(og::index_tuple_node *const node, int lvl) {
  // EMPTY
}
void og::frame_size_calculator::do_position_node(og::position_node *const node, int lvl) {
  // EMPTY
}
...
void og::frame_size_calculator::do_var_declaration_node(og::var_declaration_node * const node, int lvl) {
